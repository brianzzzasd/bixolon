            ...
            <div class="rounded-2xl bg-gray-50 p-10">
              ...
              <dl class="mt-3 space-y-1 text-sm leading-6 text-gray-600">
                <div>
                  ...
                  <dd><a class="font-semibold text-brand-primary" href="mailto:collaborate@example.com">collaborate@example.com</a></dd>
                </div>
                <div class="mt-1">
                  <dt class="sr-only">
                    Phone number
            ...
            <div class="rounded-2xl bg-gray-50 p-10">
              ...
              <dl class="mt-3 space-y-1 text-sm leading-6 text-gray-600">
                <div>
                  ...
                  <dd><a class="font-semibold text-brand-primary" href="mailto:press@example.com">press@example.com</a></dd>
                </div>
                <div class="mt-1">
                  <dt class="sr-only">
                    Phone number
            ...
            <div class="rounded-2xl bg-gray-50 p-10">
              ...
              <dl class="mt-3 space-y-1 text-sm leading-6 text-gray-600">
                <div>
                  ...
                  <dd><a class="font-semibold text-brand-primary" href="mailto:careers@example.com">careers@example.com</a></dd>
                </div>
                <div class="mt-1">
                  <dt class="sr-only">
                    Phone number
            ...
            <div class="rounded-2xl bg-gray-50 p-10">
              ...
              <dl class="mt-3 space-y-1 text-sm leading-6 text-gray-600">
                <div>
                  ...
                  <dd><a class="font-semibold text-brand-primary" href="mailto:hello@example.com">hello@example.com</a></dd>
                </div>
                <div class="mt-1">
                  <dt class="sr-only">
                    Phone number
