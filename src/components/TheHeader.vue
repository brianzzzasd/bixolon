                    ...
                    <div class="flex space-x-8 items-center">
                      <Combobox v-model="selectedPerson" as="div">
                        <div class="relative mt-1">
                          <ComboboxInput class="w-full rounded-md border border-gray-300 bg-white py-2 px-10 shadow-sm focus:border-gray-200 focus:outline-none focus:ring-1 focus:ring-gray-200 text-sm" :display-value="(person) => person?.name" placeholder="Type to search... CMD K" @change="query = $event.target.value" />
